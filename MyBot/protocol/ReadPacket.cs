...
{
    public abstract class ReadPacket : ICloneable
    {
        ...
        public static volatile bool flods = true; //TRUE QUE DIZER QUE O MACHINE NAO VAI BUGAR!!!
        public Loader LOAD;
        public ReadPacket()
        {
        }
        ...
        {
            string texto = Encoding.GetEncoding(Loader.INTs().Encoding).GetString(ReadB(qty));
